            ...
            >
                ...
                <form onSubmit={LoginUser}  >
                    <Stack gap={3} sx={{
                        ...
                        <Link to="/login" style={{ textDecoration: "none" }}>Login to a customer account .</Link>
                        <Link to="/register/seller" style={{ textDecoration: "none" }}>Dont have a account?  create a seller account</Link>
                    </Stack>
                </form>
            </Stack>
        </>
